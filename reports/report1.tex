...
\section{Task}
\label{sec:org1f5c639}
\subsection{Stimuli generation}
\label{sec:orgeb73bee}
...
\begin{center}
\includesvg[width=.9\linewidth]{./img/decisions}
\end{center}
\end{document}
